...
export const blogArticles: BlogArticle[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['FourTemperamentsTest.com', 'They want a direct exact-match four temperaments test page.', 'FourType adds score spread, subtype direction, share cards, compatibility, and practical follow-up.', 'Use exact-match quizzes for speed; use FourType when the result should keep teaching you.'],
          ['LonerWolf', 'They want four temperaments content inside a broader inner-work/self-discovery context.', 'FourType is more focused on temperament depth, blended patterns, and shareable product experience.', 'Use LonerWolf for reflective context; use FourType for a practical temperament map.'],
          ['Dwell', 'They want a temperament test from a church-resource context.', 'FourType works across general audiences with modern result sharing, subtypes, and multilingual learning paths.', 'Use Dwell for church-group context; use FourType for broader friends, couples, and teams.'],
        ],
      },
      {
        type: 'section',
    ...
    related: [
      ...
      { href: '/blog/fourtemperamentstest-com-vs-fourtype', title: 'FourTemperamentsTest.com vs FourType', description: 'Compare an exact-match quiz with FourType’s deeper result journey.' },
      { href: '/blog/lonerwolf-four-temperaments-test-vs-fourtype', title: 'LonerWolf Four Temperaments Test vs FourType', description: 'Compare inner-work framing with FourType’s practical temperament map.' },
      { href: '/blog/dwell-temperament-test-vs-fourtype', title: 'Dwell Temperament Test vs FourType', description: 'Compare a church-context test with a modern temperament platform.' },
      { href: '/blog/christian-temperament-test', title: 'Christian Temperament Test', description: 'Use temperament language for honest self-knowledge and growth.' },
      { href: '/blog/catholic-four-temperaments-test', title: 'Catholic Four Temperaments Test', description: 'Connect temperament patterns with virtues, vices, and responsible reflection.' },
    ],
    faq: [
  ...
  {
    slug: 'fourtemperamentstest-com-vs-fourtype',
    title: 'FourTemperamentsTest.com vs FourType: Exact-Match Quiz or Deeper Temperament Result?',
    shortTitle: 'FourTemperamentsTest.com vs FourType',
    description: 'Compare FourTemperamentsTest.com with FourType, including exact-match quiz intent, result depth, score spread, subtype guidance, and practical follow-up.',
    keywords: ['FourTemperamentsTest.com', 'fourtemperamentstest.com alternative', 'FourTemperamentsTest.com vs FourType', 'four temperaments test website', 'free four temperaments test comparison'],
    category: 'Comparison',
    readTime: '8 min',
    accent: 'gold',
    icon: Scale,
    image: '/images/blog/best-free-four-temperaments-test-v2.jpg',
    imageAlt: 'FourTemperamentsTest.com and FourType temperament quiz comparison',
    published: '2026-07-07',
    blocks: [
      {
        type: 'section',
        title: 'FourTemperamentsTest.com matches the search term; FourType is built for the result journey',
        body: [
          'FourTemperamentsTest.com has an obvious advantage: the domain closely matches what people search when they want a free four temperaments test. That makes it easy to understand at a glance.',
          'FourType competes from the other side: a modern quiz experience, 40 behavior-based questions, score spread, subtype direction, shareable result cards, compatibility guides, methodology notes, and multilingual pages.',
        ],
      },
      {
        type: 'grid',
        title: 'FourTemperamentsTest.com vs FourType at a glance',
        items: [
          { title: 'FourTemperamentsTest.com: exact-match clarity', body: 'Useful when you want a simple page that clearly says it is a four temperaments test.', accent: 'gold' },
          { title: 'FourType: deeper interpretation', body: 'Useful when you want the result to explain stress, communication, work style, relationships, and growth.', accent: 'blue' },
          { title: 'FourTemperamentsTest.com: quick quiz intent', body: 'Good for users who only need a fast first answer.', accent: 'green' },
          { title: 'FourType: score spread and subtypes', body: 'Better when one label is not enough and your top two temperament scores both matter.', accent: 'purple' },
        ],
      },
      {
        type: 'table',
        title: 'Which free temperament test should you choose?',
        intro: 'The right choice depends on whether you want speed, depth, or shareable follow-up.',
        columns: ['Need', 'FourTemperamentsTest.com', 'FourType'],
        rows: [
          ['Fast first label', 'Strong fit because the site is straightforward and exact-match.', 'Also works, but the quiz is designed to give more context after the label.'],
          ['Score spread', 'May be less useful if you want to understand close scores.', 'Shows how your answers distribute across all four temperaments.'],
          ['Blended subtype', 'Useful mainly for the primary type unless the result explains blends clearly.', 'Points toward primary-secondary subtype direction.'],
          ['Sharing with friends', 'Simple quiz sharing can work.', 'Built around share cards and comparison-style follow-up.'],
          ['Responsible limits', 'Depends on how the result is framed.', 'Explicitly avoids clinical, hiring, medical, or permanent-identity claims.'],
        ],
      },
      {
        type: 'callout',
        title: 'The FourType recommendation',
        body: 'Use FourTemperamentsTest.com when you want the fastest exact-match path. Use FourType when you want a free result with enough depth to keep learning after the quiz.',
        bullets: ['Take FourType first if score spread matters.', 'Use the subtype page when two types feel close.', 'Compare results with a friend when communication matters.', 'Read methodology before treating any temperament result as final.'],
      },
    ],
    related: [
      { href: '/blog/temperament-test-comparison', title: 'Temperament Test Comparison', description: 'Compare major temperament test options.' },
      ...
      { href: '/four-temperaments-test', title: 'Four Temperaments Test', description: 'Take the free FourType quiz path.' },
      { href: '/quiz', title: 'Take the Free FourType Quiz', description: 'Get your score spread and subtype direction.' },
    ],
    faq: [
      { question: 'Is FourType a FourTemperamentsTest.com alternative?', answer: 'Yes. FourType is an alternative for users who want a free four temperaments test with score spread, subtype guidance, shareable results, and practical follow-up guides.' },
      { question: 'Which site is better for a fast temperament label?', answer: 'FourTemperamentsTest.com is direct and exact-match. FourType is better if you want more context after the first label.' },
      { question: 'Why choose FourType if another site has the exact-match domain?', answer: 'Choose FourType when result depth, score spread, subtypes, relationship insight, work-style guidance, and responsible limits matter more than the domain name.' },
    ],
  },
  {
    slug: 'lonerwolf-four-temperaments-test-vs-fourtype',
    title: 'LonerWolf Four Temperaments Test vs FourType: Inner Work Quiz or Practical Temperament Map?',
    shortTitle: 'LonerWolf Four Temperaments Test vs FourType',
    description: 'Compare the LonerWolf four temperaments test with FourType, including inner-work framing, result depth, shareability, subtype guidance, and practical self-knowledge.',
    keywords: ['LonerWolf four temperaments test', 'LonerWolf temperament test', 'LonerWolf vs FourType', 'four temperaments test alternative', 'inner work temperament quiz'],
    category: 'Comparison',
    readTime: '8 min',
    accent: 'purple',
    icon: Sparkles,
    image: '/images/blog/four-temperaments-differences.jpg',
    imageAlt: 'LonerWolf four temperaments test and FourType comparison',
    published: '2026-07-07',
    blocks: [
      {
        type: 'section',
        title: 'LonerWolf frames temperament as inner work; FourType frames it as practical pattern language',
        body: [
          'LonerWolf has a strong audience around self-discovery, inner work, and reflective personality content. Its four temperaments test can appeal to people who want a softer, spiritual-growth entry point.',
          'FourType is designed for a different kind of usefulness: a focused four-temperaments platform with a free quiz, score spread, subtype pages, compatibility content, comparison guides, and share cards people can send to friends.',
        ],
      },
      {
        type: 'grid',
        title: 'LonerWolf vs FourType at a glance',
        items: [
          { title: 'LonerWolf: inner-work context', body: 'Useful if you already read LonerWolf for self-discovery and reflective growth content.', accent: 'purple' },
          { title: 'FourType: temperament-specific depth', body: 'Useful if you want one site focused entirely on Choleric, Sanguine, Melancholic, Phlegmatic, and blends.', accent: 'gold' },
          { title: 'LonerWolf: editorial authority', body: 'A good fit when you value an established self-development publisher and article-style guidance.', accent: 'blue' },
          { title: 'FourType: product experience', body: 'A good fit when you want result cards, subtype pages, compatibility, and practical next steps after the quiz.', accent: 'green' },
        ],
      },
      {
        type: 'section',
        title: 'Where FourType may feel more specific',
        body: [
          'A general self-discovery article can introduce the temperaments well. FourType goes deeper after the first result by showing how strong each temperament score is and whether your second score changes the interpretation.',
          'That matters because many people are blends. A Sanguine-Melancholic and Sanguine-Choleric may both feel expressive, but their emotional rhythm, conflict style, and growth edge can be very different.',
        ],
      },
      {
        type: 'callout',
        title: 'Which one should you take?',
        body: 'Use LonerWolf when you want a broader inner-work context. Use FourType when you want a dedicated temperament test that turns your result into subtype, relationship, work, and growth insight.',
        bullets: ['Choose FourType for score spread.', 'Choose FourType for shareable result cards.', 'Choose LonerWolf if you prefer a broader self-development article context.', 'Use either result as reflection, not diagnosis.'],
      },
    ],
    related: [
      { href: '/blog/personality-test-vs-temperament-test', title: 'Personality Test vs Temperament Test', description: 'Understand temperament as a practical self-knowledge layer.' },
      { href: '/blog/how-to-read-temperament-test-results', title: 'How to Read Temperament Test Results', description: 'Use score spread and subtypes well.' },
      { href: '/blog/temperament-test-comparison', title: 'Temperament Test Comparison', description: 'Compare major test options.' },
      { href: '/quiz', title: 'Take the Free FourType Quiz', description: 'Start with the 40-question FourType test.' },
    ],
    faq: [
      { question: 'Is FourType a LonerWolf temperament test alternative?', answer: 'Yes. FourType is an alternative if you want a dedicated four temperaments quiz with score spread, subtype guidance, and practical follow-up content.' },
      { question: 'Is LonerWolf or FourType more practical?', answer: 'FourType is more focused on practical temperament application after the quiz, while LonerWolf may appeal more to broader inner-work readers.' },
      { question: 'Can I take both tests?', answer: 'Yes. If results agree, treat that as a useful signal. If they differ, compare the actual behavior descriptions instead of collecting labels.' },
    ],
  },
  {
    slug: 'dwell-temperament-test-vs-fourtype',
    title: 'Dwell Temperament Test vs FourType: Church Resource or Modern Temperament Platform?',
    shortTitle: 'Dwell Temperament Test vs FourType',
    description: 'Compare Dwell Community Church’s temperament test with FourType, including faith context, free quiz access, subtype depth, result sharing, and responsible use.',
    keywords: ['Dwell temperament test', 'Dwell Community Church temperament test', 'Dwell vs FourType', 'Christian temperament test alternative', 'church temperament test'],
    category: 'Comparison',
    readTime: '8 min',
    accent: 'green',
    icon: Heart,
    image: '/images/history-temperaments.jpg',
    imageAlt: 'Dwell temperament test and FourType comparison',
    published: '2026-07-07',
    blocks: [
      {
        type: 'section',
        title: 'Dwell serves a faith-community context; FourType serves a broader self-knowledge audience',
        body: [
          'Dwell Community Church’s temperament test appears in a church resource context. That can be useful for groups that already trust Dwell and want temperament language for ministry, community, or small-group discussion.',
          'FourType is intentionally broader. It keeps the core result free, uses modern shareable design, and builds a full learning path around subtypes, relationships, work style, methodology, and multilingual access.',
        ],
      },
      {
        type: 'grid',
        title: 'Dwell vs FourType at a glance',
        items: [
          { title: 'Dwell: church resource', body: 'Useful when the temperament discussion is happening inside a Christian community or group setting.', accent: 'green' },
          { title: 'FourType: general audience', body: 'Useful when friends, partners, teams, or international visitors want accessible temperament language.', accent: 'gold' },
          { title: 'Dwell: simple education path', body: 'Good for introducing primary and secondary temperament language in a familiar resource library.', accent: 'blue' },
          { title: 'FourType: deeper product layer', body: 'Good for score spread, subtype interpretation, share cards, compatibility pages, and comparison guides.', accent: 'purple' },
        ],
      },
      {
        type: 'section',
        title: 'Where FourType can be more useful after the quiz',
        body: [
          'FourType is built around what happens after someone gets a result. Users can read subtype profiles, compare relationship dynamics, understand work-style patterns, and share a result card that invites friends to take the test too.',
          'That makes FourType stronger when the goal is distribution and continued learning rather than a one-time group handout.',
        ],
      },
      {
        type: 'callout',
        title: 'Which one should you choose?',
        body: 'Use Dwell if you specifically want a church-context resource. Use FourType if you want a modern free temperament test that works across friends, couples, teams, and international audiences.',
        bullets: ['Use FourType when score spread matters.', 'Use Dwell when the faith-community context matters most.', 'Use FourType for shareability and subtype depth.', 'Do not use either test for diagnosis or hiring decisions.'],
      },
    ],
    related: [
      { href: '/blog/christian-temperament-test', title: 'Christian Temperament Test', description: 'Use four temperaments language for honest self-knowledge and growth.' },
      { href: '/blog/catholic-four-temperaments-test', title: 'Catholic Four Temperaments Test', description: 'Connect temperament patterns with virtues, vices, and responsible reflection.' },
      { href: '/blog/four-humors-test', title: 'Four Humors Test', description: 'Understand the historical roots of temperament language.' },
      { href: '/blog/four-temperaments-compatibility', title: 'Four Temperaments Compatibility', description: 'Use temperament in relationships and groups.' },
    ],
    faq: [
      { question: 'Is FourType a Dwell temperament test alternative?', answer: 'Yes. FourType is an alternative for users who want a modern free temperament test with score spread, subtype guidance, shareable results, and a broader learning path.' },
      { question: 'Is FourType a Christian temperament test?', answer: 'FourType is not built specifically as a Christian test. It is a general self-reflection tool that can still be discussed in faith, family, friendship, or work contexts.' },
      { question: 'Which is better for groups?', answer: 'Dwell may fit church groups that already use Dwell resources. FourType is stronger when the group wants shareable results, subtype depth, and broader follow-up content.' },
    ],
  },
  {
    slug: 'christian-temperament-test',
    title: 'Christian Temperament Test: Using the Four Temperaments for Honest Self-Knowledge',
    shortTitle: 'Christian Temperament Test',
    description: 'A responsible guide to using a Christian temperament test for self-knowledge, relationships, small groups, virtues, blind spots, and spiritual growth.',
    keywords: ['Christian temperament test', 'Christian four temperaments test', 'four temperaments Christian', 'temperament test for Christians', 'spiritual temperament test', 'church temperament test'],
    category: 'Faith',
    readTime: '9 min',
    accent: 'green',
    icon: Heart,
    image: '/images/history-temperaments.jpg',
    imageAlt: 'Christian temperament test guide for four temperaments self-knowledge',
    published: '2026-07-07',
    blocks: [
      {
        type: 'section',
        title: 'A Christian temperament test should help you tell the truth about yourself',
        body: [
      ...
      {
        type: 'grid',
        title: 'How the four temperaments can show up in Christian growth',
        intro: 'These are reflective patterns, not fixed judgments about anyone’s faith.',
        items: [
          { title: 'Choleric: strength and surrender', body: 'A Choleric may lead decisively, but needs to practice patience, gentleness, and listening before control becomes pride.', accent: 'red' },
          { title: 'Sanguine: joy and faithfulness', body: 'A Sanguine may bring warmth and energy, but needs follow-through when excitement fades.', accent: 'gold' },
          { title: 'Melancholic: depth and hope', body: 'A Melancholic may love truth and meaning, but needs hope when analysis turns into heaviness or criticism.', accent: 'blue' },
          { title: 'Phlegmatic: peace and courage', body: 'A Phlegmatic may create stability, but needs courage when peacekeeping becomes silence or avoidance.', accent: 'green' },
        ],
      },
      {
        type: 'table',
        title: 'Christian temperament test uses and limits',
        intro: 'Use temperament language where it helps people grow. Do not use it where it replaces wisdom, counsel, or responsibility.',
        columns: ['Use case', 'Helpful use', 'Unhelpful use'],
        rows: [
          ['Small groups', 'Discuss communication and conflict patterns with humility.', 'Label people publicly or reduce them to a type.'],
          ['Marriage and friendship', 'Notice stress responses and repair moves.', 'Use a result to blame the other person.'],
          ['Leadership', 'Understand how people make decisions and receive feedback.', 'Screen people as spiritually mature or immature.'],
          ['Personal growth', 'Name a blind spot and choose one practice this week.', 'Treat temperament as destiny.'],
          ['Pastoral care', 'Use as informal reflection language.', 'Replace pastoral, medical, or mental-health support.'],
        ],
      },
      {
        type: 'callout',
        title: 'The FourType recommendation',
        body: 'Take FourType as a free self-reflection quiz first, then use the result as a conversation starter. The most useful question is not “what type am I?” but “what does this reveal about how I love, avoid, lead, react, and grow?”',
        bullets: ['Read the score spread, not only the label.', 'Pay attention to the blind spot that bothers you most.', 'Ask someone who knows you if the result fits.', 'Choose one repair move for this week.'],
      },
    ],
    related: [
      { href: '/blog/dwell-temperament-test-vs-fourtype', title: 'Dwell Temperament Test vs FourType', description: 'Compare church-context temperament resources with FourType.' },
      { href: '/blog/catholic-four-temperaments-test', title: 'Catholic Four Temperaments Test', description: 'Use temperament language for virtues, vices, and self-knowledge.' },
      { href: '/blog/four-humors-test', title: 'Four Humors Test', description: 'Understand the older historical roots of the model.' },
      { href: '/quiz', title: 'Take the Free FourType Quiz', description: 'Start with a free score spread and subtype direction.' },
    ],
    faq: [
      { question: 'Is FourType a Christian temperament test?', answer: 'FourType is a general four temperaments self-reflection test, not a church-specific or doctrinal assessment. Christians can still use it as a practical conversation tool for self-knowledge, relationships, and growth.' },
      { question: 'Can Christians use the four temperaments?', answer: 'Many Christians use the four temperaments as informal language for self-knowledge. It should be used humbly and responsibly, not as a spiritual label or excuse.' },
      { question: 'What is the best Christian use of temperament testing?', answer: 'The best use is to notice patterns that affect love, patience, courage, humility, conflict, and repair. It should support growth rather than replace discernment or counsel.' },
    ],
  },
  {
    slug: 'catholic-four-temperaments-test',
    title: 'Catholic Four Temperaments Test: Virtues, Vices, and Self-Knowledge',
    shortTitle: 'Catholic Four Temperaments Test',
    description: 'A practical Catholic-friendly guide to the four temperaments test, including virtues, vices, spiritual growth, relationships, and responsible limits.',
    keywords: ['Catholic four temperaments test', 'Catholic temperament test', 'four temperaments Catholic', 'temperament test Catholic', 'virtues and vices temperament', 'Catholic personality test'],
    category: 'Faith',
    readTime: '9 min',
    accent: 'gold',
    icon: BookOpen,
    image: '/images/blog/four-humors-test.jpg',
    imageAlt: 'Catholic four temperaments test guide for virtues and self-knowledge',
    published: '2026-07-07',
    blocks: [
      {
        type: 'section',
        title: 'Catholic readers often use temperament as a map for virtues and vices',
        body: [
      ...
      {
        type: 'grid',
        title: 'Virtue-oriented reflection by temperament',
        items: [
          { title: 'Choleric', body: 'Strength can become impatience or pride. Growth often means gentleness, humility, mercy, and patience with slower people.', accent: 'red' },
          { title: 'Sanguine', body: 'Joy can become distraction or inconsistency. Growth often means faithfulness, temperance, recollection, and finishing what was promised.', accent: 'gold' },
          { title: 'Melancholic', body: 'Depth can become scrupulosity, criticism, or despair. Growth often means hope, gratitude, trust, and offering imperfect work.', accent: 'blue' },
          { title: 'Phlegmatic', body: 'Peace can become passivity or fear of conflict. Growth often means fortitude, honesty, initiative, and clear speech.', accent: 'green' },
        ],
      },
      {
        type: 'section',
        title: 'Why blended temperaments matter',
        body: [
      ...
      {
        type: 'table',
        title: 'Catholic four temperaments test checklist',
        intro: 'A useful test should help reflection without overclaiming.',
      ...
      {
        type: 'callout',
        title: 'A responsible way to use FourType as a Catholic reader',
        body: 'Take the free quiz, read the score spread, then ask: where does this pattern help me love well, and where does it make love harder?',
        bullets: ['Use your result for examination, not excuse-making.', 'Discuss it gently with a spouse, friend, or small group.', 'Do not treat a quiz as spiritual direction.', 'Choose one virtue practice that matches your blind spot.'],
      },
    ],
    related: [
      { href: '/blog/christian-temperament-test', title: 'Christian Temperament Test', description: 'Use temperament language for honest self-knowledge and growth.' },
      { href: '/blog/four-humors-test', title: 'Four Humors Test', description: 'Learn the older history behind temperament language.' },
      { href: '/blog/dwell-temperament-test-vs-fourtype', title: 'Dwell Temperament Test vs FourType', description: 'Compare a church-resource temperament test with FourType.' },
      { href: '/quiz', title: 'Take the Free FourType Quiz', description: 'Get a score spread across all four temperaments.' },
    ],
    faq: [
      { question: 'Is FourType a Catholic temperament test?', answer: 'FourType is not specifically Catholic, but Catholic readers can use it as a free four temperaments self-reflection tool alongside their own tradition of virtues, vices, and spiritual growth.' },
      { question: 'Which temperament is best for Catholics?', answer: 'No temperament is spiritually better. Each pattern has strengths, temptations, and growth edges. The point is self-knowledge that leads to virtue and love.' },
      { question: 'Can a temperament test replace spiritual direction?', answer: 'No. A temperament test can support reflection, but it should not replace confession, spiritual direction, pastoral care, therapy, or wise counsel.' },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'section',
        title: 'Start with curiosity, not a verdict',
        body: ['Take the quiz separately. A result is a hypothesis about repeated behavior, not a way to diagnose your partner.'],
      },
      {
        type: 'table',
      ...
      {
        type: 'grid',
        title: 'What helps each pattern stay in the room',
        items: [
      ...
      {
        type: 'callout',
        title: 'End with one small agreement',
        body: 'Choose a behavior, not a personality promise.',
        bullets: ['Name the agreement in one sentence.', 'Choose a time to check in.', 'Repair the miss instead of scoring it.'],
      },
      {
        type: 'section',
        title: 'When the conversation needs more than a guide',
        body: ['Temperament does not excuse coercion, intimidation, contempt, or harm. If a conversation is unsafe, prioritize support and safety over a better script.'],
      },
    ],
    related: [
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'section',
        title: 'A child is more than a pattern',
        body: ['Temperament is not a diagnosis. It should never be used to call a child difficult, lazy, dramatic, or broken.'],
      },
      {
        type: 'grid',
        title: 'What to notice before you label',
        items: [
      ...
      {
        type: 'table',
        title: 'Support without overreach',
        columns: ['Pattern', 'What may help', 'What to avoid'],
        rows: [
          ['Commander (Choleric)', 'Clear choices and a useful responsibility.', 'Turning every strong reaction into defiance.'],
          ['Bard (Sanguine)', 'Warm attention and gentle structure.', 'Calling ordinary emotion manipulation.'],
          ['Strategist (Melancholic)', 'Preparation and room to ask questions.', 'Treating care or sensitivity as a problem.'],
          ['Guardian (Phlegmatic)', 'Low-pressure invitations and time to answer.', 'Mistaking quietness for agreement.'],
        ],
      },
      {
        type: 'table',
      ...
      {
        type: 'callout',
        title: 'Use the quiz on yourself first',
        body: 'The quiz is an adult self-reflection tool. Start with your own pressure pattern before deciding what a child needs.',
        bullets: ['Notice your own first move.', 'Lower the pressure before teaching.', 'Ask what support would make the next step possible.'],
      },
    ],
    related: [
...
export const coreGuideLinks: LinkCard[] = [
  ...
  { href: '/blog/fourtemperamentstest-com-vs-fourtype', title: 'FourTemperamentsTest.com vs FourType', description: 'Compare exact-match quiz intent with FourType depth.' },
  { href: '/blog/lonerwolf-four-temperaments-test-vs-fourtype', title: 'LonerWolf vs FourType', description: 'Compare inner-work temperament content with FourType.' },
  { href: '/blog/dwell-temperament-test-vs-fourtype', title: 'Dwell vs FourType', description: 'Compare church-context temperament resources with FourType.' },
  { href: '/blog/christian-temperament-test', title: 'Christian Temperament Test', description: 'Use four temperaments language for honest self-knowledge and growth.' },
  { href: '/blog/catholic-four-temperaments-test', title: 'Catholic Four Temperaments Test', description: 'Connect temperament patterns with virtues, vices, and responsible reflection.' },
