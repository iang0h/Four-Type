...
export const blogArticles: BlogArticle[] = [
  ...
  },
  {
    ...
    related: [
      ...
      { href: '/methodology', title: 'FourType Methodology', description: 'See FourType’s responsible-use framing.' },
      { href: '/quiz', title: 'Take the Free FourType Quiz', description: 'Try the modern free temperament test.' },
    ],
    faq: [
