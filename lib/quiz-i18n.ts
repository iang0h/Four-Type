...
const enCopy: QuizCopy = {
  ...
  results: {
    ...
    leadCapture: {
      ...
      submitting: 'Saving...',
      success: 'Saved. Your email was added to the FourType early access list.',
...
const zhCopy: QuizCopy = {
  ...
  results: {
    ...
    leadCapture: {
      ...
      button: '加入抢先体验',
      submitting: '正在保存...',
      success: '已保存。你的邮箱已加入 FourType 抢先体验名单。',
      error: '出了点问题。请稍后再试。',
...
const esCopy: QuizCopy = {
  ...
  results: {
    ...
    leadCapture: {
      ...
      success: 'Guardado. Tu email se añadió a la lista de acceso anticipado de FourType.',
